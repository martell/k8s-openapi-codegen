...
pub struct StatefulSet {
    ...
    pub spec: Option<::v1_9::api::apps::v1beta1::StatefulSetSpec>,

    /// Status is the current status of Pods in this StatefulSet. This data may be out of date by some window of time.
    pub status: Option<::v1_9::api::apps::v1beta1::StatefulSetStatus>,
}
...
impl StatefulSet {
    ...
    pub fn create_apps_v1beta1_namespaced_stateful_set(
        namespace: &str,
        body: &::v1_9::api::apps::v1beta1::StatefulSet,
        pretty: Option<&str>,
...
pub enum CreateAppsV1beta1NamespacedStatefulSetResponse {
    Ok(::v1_9::api::apps::v1beta1::StatefulSet),
    Created(::v1_9::api::apps::v1beta1::StatefulSet),
    Accepted(::v1_9::api::apps::v1beta1::StatefulSet),
    Unauthorized,
    Other,
}
...
pub enum DeleteAppsV1beta1CollectionNamespacedStatefulSetResponse {
    ...
    OkValue(::v1_9::api::apps::v1beta1::StatefulSet),
    Unauthorized,
    Other,
}
...
pub enum ListAppsV1beta1NamespacedStatefulSetResponse {
    Ok(::v1_9::api::apps::v1beta1::StatefulSetList),
    Unauthorized,
    Other,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<::v1_9::api::apps::v1beta1::StatefulSetSpec> = None;
                let mut value_status: Option<::v1_9::api::apps::v1beta1::StatefulSetStatus> = None;
