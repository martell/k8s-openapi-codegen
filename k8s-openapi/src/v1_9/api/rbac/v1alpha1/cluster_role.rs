...
pub struct ClusterRole {
    ...
    pub aggregation_rule: Option<::v1_9::api::rbac::v1alpha1::AggregationRule>,
...
impl ClusterRole {
    ...
    pub fn create_rbac_authorization_v1alpha1_cluster_role(
        body: &::v1_9::api::rbac::v1alpha1::ClusterRole,
        pretty: Option<&str>,
...
pub enum CreateRbacAuthorizationV1alpha1ClusterRoleResponse {
    Ok(::v1_9::api::rbac::v1alpha1::ClusterRole),
    Created(::v1_9::api::rbac::v1alpha1::ClusterRole),
    Accepted(::v1_9::api::rbac::v1alpha1::ClusterRole),
    Unauthorized,
    Other,
}
...
pub enum DeleteRbacAuthorizationV1alpha1ClusterRoleResponse {
    ...
    OkValue(::v1_9::api::rbac::v1alpha1::ClusterRole),
    Unauthorized,
    Other,
}
...
pub enum ListRbacAuthorizationV1alpha1ClusterRoleResponse {
    Ok(::v1_9::api::rbac::v1alpha1::ClusterRoleList),
    Unauthorized,
    Other,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_aggregation_rule: Option<::v1_9::api::rbac::v1alpha1::AggregationRule> = None;
