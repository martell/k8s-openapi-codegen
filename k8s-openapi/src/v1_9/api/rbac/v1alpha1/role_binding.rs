...
impl RoleBinding {
    ...
    pub fn create_rbac_authorization_v1alpha1_namespaced_role_binding(
        namespace: &str,
        body: &::v1_9::api::rbac::v1alpha1::RoleBinding,
        pretty: Option<&str>,
...
pub enum CreateRbacAuthorizationV1alpha1NamespacedRoleBindingResponse {
    Ok(::v1_9::api::rbac::v1alpha1::RoleBinding),
    Created(::v1_9::api::rbac::v1alpha1::RoleBinding),
    Accepted(::v1_9::api::rbac::v1alpha1::RoleBinding),
    Unauthorized,
    Other,
}
...
pub enum DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBindingResponse {
    ...
    OkValue(::v1_9::api::rbac::v1alpha1::RoleBinding),
    Unauthorized,
    Other,
}
...
pub enum ListRbacAuthorizationV1alpha1NamespacedRoleBindingResponse {
    Ok(::v1_9::api::rbac::v1alpha1::RoleBindingList),
    Unauthorized,
    Other,
}
