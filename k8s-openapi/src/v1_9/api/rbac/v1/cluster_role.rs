...
impl ClusterRole {
    ...
    pub fn create_rbac_authorization_v1_cluster_role(
        body: &::v1_9::api::rbac::v1::ClusterRole,
        pretty: Option<&str>,
...
pub enum CreateRbacAuthorizationV1ClusterRoleResponse {
    Ok(::v1_9::api::rbac::v1::ClusterRole),
    Created(::v1_9::api::rbac::v1::ClusterRole),
    Accepted(::v1_9::api::rbac::v1::ClusterRole),
    Unauthorized,
    Other,
}
...
pub enum DeleteRbacAuthorizationV1ClusterRoleResponse {
    ...
    OkValue(::v1_9::api::rbac::v1::ClusterRole),
    Unauthorized,
    Other,
}
...
pub enum ListRbacAuthorizationV1ClusterRoleResponse {
    Ok(::v1_9::api::rbac::v1::ClusterRoleList),
    Unauthorized,
    Other,
}
