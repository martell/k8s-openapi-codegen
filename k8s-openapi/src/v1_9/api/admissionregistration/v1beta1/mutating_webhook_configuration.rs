...
impl MutatingWebhookConfiguration {
    ...
    pub fn create_admissionregistration_v1beta1_mutating_webhook_configuration(
        body: &::v1_9::api::admissionregistration::v1beta1::MutatingWebhookConfiguration,
        pretty: Option<&str>,
...
pub enum CreateAdmissionregistrationV1beta1MutatingWebhookConfigurationResponse {
    Ok(::v1_9::api::admissionregistration::v1beta1::MutatingWebhookConfiguration),
    Created(::v1_9::api::admissionregistration::v1beta1::MutatingWebhookConfiguration),
    Accepted(::v1_9::api::admissionregistration::v1beta1::MutatingWebhookConfiguration),
    Unauthorized,
    Other,
}
...
pub enum DeleteAdmissionregistrationV1beta1CollectionMutatingWebhookConfigurationResponse {
    ...
    OkValue(::v1_9::api::admissionregistration::v1beta1::MutatingWebhookConfiguration),
    Unauthorized,
    Other,
}
...
pub enum ListAdmissionregistrationV1beta1MutatingWebhookConfigurationResponse {
    Ok(::v1_9::api::admissionregistration::v1beta1::MutatingWebhookConfigurationList),
    Unauthorized,
    Other,
}
