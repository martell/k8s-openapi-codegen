// Generated from definition io.k8s.api.apps.v1beta2.ReplicaSetList

/// ReplicaSetList is a collection of ReplicaSets.
#[derive(Clone, Debug, Default, PartialEq)]
pub struct ReplicaSetList {
    /// List of ReplicaSets. More info: https://kubernetes.io/docs/concepts/workloads/controllers/replicationcontroller
    pub items: Vec<::v1_12::api::apps::v1beta2::ReplicaSet>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<::v1_12::api::apps::v1beta2::ReplicaSet>> = None;
