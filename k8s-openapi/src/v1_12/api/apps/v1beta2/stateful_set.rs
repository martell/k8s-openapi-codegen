...
pub struct StatefulSet {
    ...
    pub spec: Option<::v1_12::api::apps::v1beta2::StatefulSetSpec>,

    /// Status is the current status of Pods in this StatefulSet. This data may be out of date by some window of time.
    pub status: Option<::v1_12::api::apps::v1beta2::StatefulSetStatus>,
}
...
impl StatefulSet {
    ...
    pub fn create_apps_v1beta2_namespaced_stateful_set(
        namespace: &str,
        body: &::v1_12::api::apps::v1beta2::StatefulSet,
        pretty: Option<&str>,
...
pub enum CreateAppsV1beta2NamespacedStatefulSetResponse {
    Ok(::v1_12::api::apps::v1beta2::StatefulSet),
    Created(::v1_12::api::apps::v1beta2::StatefulSet),
    Accepted(::v1_12::api::apps::v1beta2::StatefulSet),
    Unauthorized,
    Other,
}
...
pub enum DeleteAppsV1beta2CollectionNamespacedStatefulSetResponse {
    ...
    OkValue(::v1_12::api::apps::v1beta2::StatefulSet),
    Unauthorized,
    Other,
}
    ...
    fn try_from_parts(status_code: ::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), ::ResponseError> {
        match status_code {
            ...
            ::http::StatusCode::ACCEPTED => {
                ...
                Ok((DeleteAppsV1beta2NamespacedStatefulSetResponse::Accepted(result), buf.len()))
            },
...
pub enum ListAppsV1beta2NamespacedStatefulSetResponse {
    Ok(::v1_12::api::apps::v1beta2::StatefulSetList),
    Unauthorized,
    Other,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<::v1_12::api::apps::v1beta2::StatefulSetSpec> = None;
                let mut value_status: Option<::v1_12::api::apps::v1beta2::StatefulSetStatus> = None;
