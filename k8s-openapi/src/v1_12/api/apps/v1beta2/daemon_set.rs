...
pub struct DaemonSet {
    ...
    pub spec: Option<::v1_12::api::apps::v1beta2::DaemonSetSpec>,

    /// The current status of this daemon set. This data may be out of date by some window of time. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
    pub status: Option<::v1_12::api::apps::v1beta2::DaemonSetStatus>,
}
...
impl DaemonSet {
    ...
    pub fn create_apps_v1beta2_namespaced_daemon_set(
        namespace: &str,
        body: &::v1_12::api::apps::v1beta2::DaemonSet,
        pretty: Option<&str>,
...
pub enum CreateAppsV1beta2NamespacedDaemonSetResponse {
    Ok(::v1_12::api::apps::v1beta2::DaemonSet),
    Created(::v1_12::api::apps::v1beta2::DaemonSet),
    Accepted(::v1_12::api::apps::v1beta2::DaemonSet),
    Unauthorized,
    Other,
}
...
pub enum DeleteAppsV1beta2CollectionNamespacedDaemonSetResponse {
    ...
    OkValue(::v1_12::api::apps::v1beta2::DaemonSet),
    Unauthorized,
    Other,
}
        ...
        match status_code {
            ::http::StatusCode::OK => {
                ...
                if is_status {
                    ...
                    Ok((DeleteAppsV1beta2CollectionNamespacedDaemonSetResponse::OkStatus(result), buf.len()))
                }
                else {
                    let result = ::serde::Deserialize::deserialize(::serde_json::Value::Object(result));
                    let result = result.map_err(::ResponseError::Json)?;
                    Ok((DeleteAppsV1beta2CollectionNamespacedDaemonSetResponse::OkValue(result), buf.len()))
                }
            },
        ...
        match status_code {
            ::http::StatusCode::OK => {
                ...
                if is_status {
                    let result = ::serde::Deserialize::deserialize(::serde_json::Value::Object(result));
                    let result = result.map_err(::ResponseError::Json)?;
                    Ok((DeleteAppsV1beta2NamespacedDaemonSetResponse::OkStatus(result), buf.len()))
                }
                else {
                    let result = ::serde::Deserialize::deserialize(::serde_json::Value::Object(result));
                    let result = result.map_err(::ResponseError::Json)?;
                    Ok((DeleteAppsV1beta2NamespacedDaemonSetResponse::OkValue(result), buf.len()))
                }
            },
            ::http::StatusCode::ACCEPTED => {
                let result = match ::serde_json::from_slice(buf) {
                ...
                Ok((DeleteAppsV1beta2NamespacedDaemonSetResponse::Accepted(result), buf.len()))
            },
...
pub enum ListAppsV1beta2DaemonSetForAllNamespacesResponse {
    Ok(::v1_12::api::apps::v1beta2::DaemonSetList),
    Unauthorized,
    Other,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<::v1_12::api::apps::v1beta2::DaemonSetSpec> = None;
                let mut value_status: Option<::v1_12::api::apps::v1beta2::DaemonSetStatus> = None;
