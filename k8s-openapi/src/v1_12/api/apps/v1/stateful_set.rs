...
pub struct StatefulSet {
    ...
    pub spec: Option<::v1_12::api::apps::v1::StatefulSetSpec>,

    /// Status is the current status of Pods in this StatefulSet. This data may be out of date by some window of time.
    pub status: Option<::v1_12::api::apps::v1::StatefulSetStatus>,
}
...
impl StatefulSet {
    ...
    pub fn create_apps_v1_namespaced_stateful_set(
        namespace: &str,
        body: &::v1_12::api::apps::v1::StatefulSet,
        pretty: Option<&str>,
...
pub enum CreateAppsV1NamespacedStatefulSetResponse {
    Ok(::v1_12::api::apps::v1::StatefulSet),
    Created(::v1_12::api::apps::v1::StatefulSet),
    Accepted(::v1_12::api::apps::v1::StatefulSet),
    Unauthorized,
    Other,
}
...
pub enum DeleteAppsV1CollectionNamespacedStatefulSetResponse {
    ...
    OkValue(::v1_12::api::apps::v1::StatefulSet),
    Unauthorized,
    Other,
}
    ...
    fn try_from_parts(status_code: ::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), ::ResponseError> {
        match status_code {
            ...
            ::http::StatusCode::ACCEPTED => {
                ...
                Ok((DeleteAppsV1NamespacedStatefulSetResponse::Accepted(result), buf.len()))
            },
...
pub enum ListAppsV1NamespacedStatefulSetResponse {
    Ok(::v1_12::api::apps::v1::StatefulSetList),
    Unauthorized,
    Other,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<::v1_12::api::apps::v1::StatefulSetSpec> = None;
                let mut value_status: Option<::v1_12::api::apps::v1::StatefulSetStatus> = None;
