...
impl ControllerRevision {
    ...
    pub fn create_apps_v1_namespaced_controller_revision(
        namespace: &str,
        body: &::v1_12::api::apps::v1::ControllerRevision,
        pretty: Option<&str>,
...
pub enum CreateAppsV1NamespacedControllerRevisionResponse {
    Ok(::v1_12::api::apps::v1::ControllerRevision),
    Created(::v1_12::api::apps::v1::ControllerRevision),
    Accepted(::v1_12::api::apps::v1::ControllerRevision),
    Unauthorized,
    Other,
}
...
pub enum DeleteAppsV1CollectionNamespacedControllerRevisionResponse {
    ...
    OkValue(::v1_12::api::apps::v1::ControllerRevision),
    Unauthorized,
    Other,
}
    ...
    fn try_from_parts(status_code: ::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), ::ResponseError> {
        match status_code {
            ...
            ::http::StatusCode::ACCEPTED => {
                ...
                Ok((DeleteAppsV1NamespacedControllerRevisionResponse::Accepted(result), buf.len()))
            },
...
pub enum ListAppsV1ControllerRevisionForAllNamespacesResponse {
    Ok(::v1_12::api::apps::v1::ControllerRevisionList),
    Unauthorized,
    Other,
}
