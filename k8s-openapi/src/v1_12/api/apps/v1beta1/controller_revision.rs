...
impl ControllerRevision {
    ...
    pub fn create_apps_v1beta1_namespaced_controller_revision(
        namespace: &str,
        body: &::v1_12::api::apps::v1beta1::ControllerRevision,
        pretty: Option<&str>,
...
pub enum CreateAppsV1beta1NamespacedControllerRevisionResponse {
    Ok(::v1_12::api::apps::v1beta1::ControllerRevision),
    Created(::v1_12::api::apps::v1beta1::ControllerRevision),
    Accepted(::v1_12::api::apps::v1beta1::ControllerRevision),
    Unauthorized,
    Other,
}
...
pub enum DeleteAppsV1beta1CollectionNamespacedControllerRevisionResponse {
    ...
    OkValue(::v1_12::api::apps::v1beta1::ControllerRevision),
    Unauthorized,
    Other,
}
    ...
    fn try_from_parts(status_code: ::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), ::ResponseError> {
        match status_code {
            ...
            ::http::StatusCode::ACCEPTED => {
                ...
                Ok((DeleteAppsV1beta1NamespacedControllerRevisionResponse::Accepted(result), buf.len()))
            },
...
pub enum ListAppsV1beta1ControllerRevisionForAllNamespacesResponse {
    Ok(::v1_12::api::apps::v1beta1::ControllerRevisionList),
    Unauthorized,
    Other,
}
