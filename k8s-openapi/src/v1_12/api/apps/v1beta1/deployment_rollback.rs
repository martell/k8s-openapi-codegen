...
pub struct DeploymentRollback {
    ...
    pub rollback_to: ::v1_12::api::apps::v1beta1::RollbackConfig,
...
impl DeploymentRollback {
    ...
    pub fn create_apps_v1beta1_namespaced_deployment_rollback(
        name: &str,
        namespace: &str,
        body: &::v1_12::api::apps::v1beta1::DeploymentRollback,
        pretty: Option<&str>,
...
pub enum CreateAppsV1beta1NamespacedDeploymentRollbackResponse {
    Ok(::v1_12::api::apps::v1beta1::DeploymentStatus),
    Created(::v1_12::api::apps::v1beta1::DeploymentStatus),
    Accepted(::v1_12::api::apps::v1beta1::DeploymentStatus),
    Unauthorized,
    Other,
}
...
impl ::TypeMeta for DeploymentRollback {
