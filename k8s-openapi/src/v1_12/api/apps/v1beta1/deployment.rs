    ...
    fn try_from_parts(status_code: ::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), ::ResponseError> {
        match status_code {
            ...
            ::http::StatusCode::CREATED => {
                ...
                Ok((CreateAppsV1beta1NamespacedDeploymentResponse::Created(result), buf.len()))
            },
            ::http::StatusCode::ACCEPTED => {
                ...
                Ok((CreateAppsV1beta1NamespacedDeploymentResponse::Accepted(result), buf.len()))
            },
    ...
    fn try_from_parts(status_code: ::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), ::ResponseError> {
        match status_code {
            ...
            ::http::StatusCode::CREATED => {
                ...
                Ok((ReplaceAppsV1beta1NamespacedDeploymentResponse::Created(result), buf.len()))
            },
    ...
    fn try_from_parts(status_code: ::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), ::ResponseError> {
        match status_code {
            ...
            ::http::StatusCode::CREATED => {
                ...
                Ok((ReplaceAppsV1beta1NamespacedDeploymentStatusResponse::Created(result), buf.len()))
            },
