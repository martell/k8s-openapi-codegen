...
pub struct StorageClass {
    ...
    pub allowed_topologies: Option<Vec<::v1_12::api::core::v1::TopologySelectorTerm>>,
...
impl StorageClass {
    ...
    pub fn create_storage_v1_storage_class(
        body: &::v1_12::api::storage::v1::StorageClass,
        pretty: Option<&str>,
...
pub enum CreateStorageV1StorageClassResponse {
    Ok(::v1_12::api::storage::v1::StorageClass),
    Created(::v1_12::api::storage::v1::StorageClass),
    Accepted(::v1_12::api::storage::v1::StorageClass),
    Unauthorized,
    Other,
}
...
pub enum DeleteStorageV1CollectionStorageClassResponse {
    ...
    OkValue(::v1_12::api::storage::v1::StorageClass),
    Unauthorized,
    Other,
}
    ...
    fn try_from_parts(status_code: ::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), ::ResponseError> {
        match status_code {
            ...
            ::http::StatusCode::ACCEPTED => {
                ...
                Ok((DeleteStorageV1StorageClassResponse::Accepted(result), buf.len()))
            },
...
pub enum ListStorageV1StorageClassResponse {
    Ok(::v1_12::api::storage::v1::StorageClassList),
    Unauthorized,
    Other,
}
...
impl ::TypeMeta for StorageClass {
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                ...
                let mut value_allowed_topologies: Option<Vec<::v1_12::api::core::v1::TopologySelectorTerm>> = None;
