// Generated from definition io.k8s.api.storage.v1alpha1.VolumeAttachmentList

/// VolumeAttachmentList is a collection of VolumeAttachment objects.
#[derive(Clone, Debug, Default, PartialEq)]
pub struct VolumeAttachmentList {
    /// Items is the list of VolumeAttachments
    pub items: Vec<::v1_12::api::storage::v1alpha1::VolumeAttachment>,

    /// Standard list metadata More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata
    pub metadata: Option<::v1_12::apimachinery::pkg::apis::meta::v1::ListMeta>,
}

impl ::TypeMeta for VolumeAttachmentList {
...
impl<'de> ::serde::Deserialize<'de> for VolumeAttachmentList {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            type Value = VolumeAttachmentList;

            fn expecting(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
                write!(f, "struct VolumeAttachmentList")
            }

            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<::v1_12::api::storage::v1alpha1::VolumeAttachment>> = None;
...
impl ::serde::Serialize for VolumeAttachmentList {
