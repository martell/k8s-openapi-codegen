// Generated from definition io.k8s.api.storage.v1beta1.VolumeAttachmentList

/// VolumeAttachmentList is a collection of VolumeAttachment objects.
#[derive(Clone, Debug, Default, PartialEq)]
pub struct VolumeAttachmentList {
    /// Items is the list of VolumeAttachments
    pub items: Vec<::v1_12::api::storage::v1beta1::VolumeAttachment>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<::v1_12::api::storage::v1beta1::VolumeAttachment>> = None;
