...
pub struct CronJob {
    ...
    pub spec: Option<::v1_12::api::batch::v1beta1::CronJobSpec>,

    /// Current status of a cron job. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
    pub status: Option<::v1_12::api::batch::v1beta1::CronJobStatus>,
}
...
impl CronJob {
    ...
    pub fn create_batch_v1beta1_namespaced_cron_job(
        namespace: &str,
        body: &::v1_12::api::batch::v1beta1::CronJob,
        pretty: Option<&str>,
...
pub enum CreateBatchV1beta1NamespacedCronJobResponse {
    Ok(::v1_12::api::batch::v1beta1::CronJob),
    Created(::v1_12::api::batch::v1beta1::CronJob),
    Accepted(::v1_12::api::batch::v1beta1::CronJob),
    Unauthorized,
    Other,
}
...
pub enum DeleteBatchV1beta1CollectionNamespacedCronJobResponse {
    ...
    OkValue(::v1_12::api::batch::v1beta1::CronJob),
    Unauthorized,
    Other,
}
...
impl ::Response for DeleteBatchV1beta1NamespacedCronJobResponse {
    fn try_from_parts(status_code: ::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), ::ResponseError> {
        match status_code {
            ::http::StatusCode::OK => {
                let result: ::serde_json::Map<String, ::serde_json::Value> = match ::serde_json::from_slice(buf) {
...
pub enum ListBatchV1beta1CronJobForAllNamespacesResponse {
    Ok(::v1_12::api::batch::v1beta1::CronJobList),
    Unauthorized,
    Other,
}
...
impl ::Response for ListBatchV1beta1NamespacedCronJobResponse {
    fn try_from_parts(status_code: ::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), ::ResponseError> {
        match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
...
impl ::Response for PatchBatchV1beta1NamespacedCronJobResponse {
    fn try_from_parts(status_code: ::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), ::ResponseError> {
        match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
...
impl ::Response for PatchBatchV1beta1NamespacedCronJobStatusResponse {
    fn try_from_parts(status_code: ::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), ::ResponseError> {
        match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
...
impl ::Response for ReadBatchV1beta1NamespacedCronJobResponse {
    fn try_from_parts(status_code: ::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), ::ResponseError> {
        match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
...
impl ::Response for ReplaceBatchV1beta1NamespacedCronJobResponse {
    fn try_from_parts(status_code: ::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), ::ResponseError> {
        match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
...
impl ::Response for ReplaceBatchV1beta1NamespacedCronJobStatusResponse {
    fn try_from_parts(status_code: ::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), ::ResponseError> {
        match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
...
impl ::Response for WatchBatchV1beta1NamespacedCronJobResponse {
    fn try_from_parts(status_code: ::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), ::ResponseError> {
        match status_code {
            ::http::StatusCode::OK => {
                let mut deserializer = ::serde_json::Deserializer::from_slice(buf).into_iter();
...
impl ::Response for WatchBatchV1beta1NamespacedCronJobListResponse {
    fn try_from_parts(status_code: ::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), ::ResponseError> {
        match status_code {
            ::http::StatusCode::OK => {
                let mut deserializer = ::serde_json::Deserializer::from_slice(buf).into_iter();
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<::v1_12::api::batch::v1beta1::CronJobSpec> = None;
                let mut value_status: Option<::v1_12::api::batch::v1beta1::CronJobStatus> = None;
