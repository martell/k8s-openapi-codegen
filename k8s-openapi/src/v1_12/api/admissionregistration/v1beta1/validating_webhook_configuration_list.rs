// Generated from definition io.k8s.api.admissionregistration.v1beta1.ValidatingWebhookConfigurationList

/// ValidatingWebhookConfigurationList is a list of ValidatingWebhookConfiguration.
#[derive(Clone, Debug, Default, PartialEq)]
pub struct ValidatingWebhookConfigurationList {
    /// List of ValidatingWebhookConfiguration.
    pub items: Vec<::v1_12::api::admissionregistration::v1beta1::ValidatingWebhookConfiguration>,

    /// Standard list metadata. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#types-kinds
    pub metadata: Option<::v1_12::apimachinery::pkg::apis::meta::v1::ListMeta>,
}

impl ::TypeMeta for ValidatingWebhookConfigurationList {
...
impl<'de> ::serde::Deserialize<'de> for ValidatingWebhookConfigurationList {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            type Value = ValidatingWebhookConfigurationList;

            fn expecting(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
                write!(f, "struct ValidatingWebhookConfigurationList")
            }

            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<::v1_12::api::admissionregistration::v1beta1::ValidatingWebhookConfiguration>> = None;
                ...
                Ok(ValidatingWebhookConfigurationList {
...
impl ::serde::Serialize for ValidatingWebhookConfigurationList {
