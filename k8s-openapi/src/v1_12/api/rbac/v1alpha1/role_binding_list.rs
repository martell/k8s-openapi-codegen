// Generated from definition io.k8s.api.rbac.v1alpha1.RoleBindingList

/// RoleBindingList is a collection of RoleBindings
#[derive(Clone, Debug, Default, PartialEq)]
pub struct RoleBindingList {
    /// Items is a list of RoleBindings
    pub items: Vec<::v1_12::api::rbac::v1alpha1::RoleBinding>,

    /// Standard object's metadata.
    pub metadata: Option<::v1_12::apimachinery::pkg::apis::meta::v1::ListMeta>,
}

impl ::TypeMeta for RoleBindingList {
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<::v1_12::api::rbac::v1alpha1::RoleBinding>> = None;
