...
pub struct ClusterRoleBinding {
    ...
    pub role_ref: ::v1_12::api::rbac::v1beta1::RoleRef,

    /// Subjects holds references to the objects the role applies to.
    pub subjects: Option<Vec<::v1_12::api::rbac::v1beta1::Subject>>,
}
...
impl ClusterRoleBinding {
    ...
    pub fn create_rbac_authorization_v1beta1_cluster_role_binding(
        body: &::v1_12::api::rbac::v1beta1::ClusterRoleBinding,
        pretty: Option<&str>,
...
pub enum CreateRbacAuthorizationV1beta1ClusterRoleBindingResponse {
    Ok(::v1_12::api::rbac::v1beta1::ClusterRoleBinding),
    Created(::v1_12::api::rbac::v1beta1::ClusterRoleBinding),
    Accepted(::v1_12::api::rbac::v1beta1::ClusterRoleBinding),
    Unauthorized,
    Other,
}
...
pub enum DeleteRbacAuthorizationV1beta1ClusterRoleBindingResponse {
    ...
    OkValue(::v1_12::api::rbac::v1beta1::ClusterRoleBinding),
    ...
    fn try_from_parts(status_code: ::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), ::ResponseError> {
        match status_code {
            ...
            ::http::StatusCode::ACCEPTED => {
                ...
                Ok((DeleteRbacAuthorizationV1beta1ClusterRoleBindingResponse::Accepted(result), buf.len()))
            },
...
pub enum ListRbacAuthorizationV1beta1ClusterRoleBindingResponse {
    Ok(::v1_12::api::rbac::v1beta1::ClusterRoleBindingList),
    Unauthorized,
    Other,
}
