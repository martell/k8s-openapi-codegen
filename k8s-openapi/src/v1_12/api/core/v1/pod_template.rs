...
impl PodTemplate {
    ...
    pub fn create_core_v1_namespaced_pod_template(
        namespace: &str,
        body: &::v1_12::api::core::v1::PodTemplate,
        pretty: Option<&str>,
...
pub enum CreateCoreV1NamespacedPodTemplateResponse {
    Ok(::v1_12::api::core::v1::PodTemplate),
    Created(::v1_12::api::core::v1::PodTemplate),
    Accepted(::v1_12::api::core::v1::PodTemplate),
    Unauthorized,
    Other,
}
...
pub enum DeleteCoreV1CollectionNamespacedPodTemplateResponse {
    ...
    OkValue(::v1_12::api::core::v1::PodTemplate),
    Unauthorized,
    Other,
}
    ...
    fn try_from_parts(status_code: ::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), ::ResponseError> {
        match status_code {
            ...
            ::http::StatusCode::ACCEPTED => {
                ...
                Ok((DeleteCoreV1NamespacedPodTemplateResponse::Accepted(result), buf.len()))
            },
...
pub enum ListCoreV1NamespacedPodTemplateResponse {
    Ok(::v1_12::api::core::v1::PodTemplateList),
    Unauthorized,
    Other,
}
