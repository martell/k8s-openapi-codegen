// Generated from definition io.k8s.api.core.v1.ServiceAccountList

/// ServiceAccountList is a list of ServiceAccount objects
#[derive(Clone, Debug, Default, PartialEq)]
pub struct ServiceAccountList {
    /// List of ServiceAccounts. More info: https://kubernetes.io/docs/tasks/configure-pod-container/configure-service-account/
    pub items: Vec<::v1_12::api::core::v1::ServiceAccount>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<::v1_12::api::core::v1::ServiceAccount>> = None;
