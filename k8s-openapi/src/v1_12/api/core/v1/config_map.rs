...
impl ConfigMap {
    ...
    pub fn create_core_v1_namespaced_config_map(
        namespace: &str,
        body: &::v1_12::api::core::v1::ConfigMap,
        pretty: Option<&str>,
...
pub enum CreateCoreV1NamespacedConfigMapResponse {
    Ok(::v1_12::api::core::v1::ConfigMap),
    Created(::v1_12::api::core::v1::ConfigMap),
    Accepted(::v1_12::api::core::v1::ConfigMap),
    Unauthorized,
    Other,
}
...
pub enum DeleteCoreV1CollectionNamespacedConfigMapResponse {
    ...
    OkValue(::v1_12::api::core::v1::ConfigMap),
    Unauthorized,
    Other,
}
    ...
    fn try_from_parts(status_code: ::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), ::ResponseError> {
        match status_code {
            ...
            ::http::StatusCode::ACCEPTED => {
                ...
                Ok((DeleteCoreV1NamespacedConfigMapResponse::Accepted(result), buf.len()))
            },
...
pub enum ListCoreV1ConfigMapForAllNamespacesResponse {
    Ok(::v1_12::api::core::v1::ConfigMapList),
    Unauthorized,
    Other,
}
