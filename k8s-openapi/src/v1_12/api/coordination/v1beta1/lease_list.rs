// Generated from definition io.k8s.api.coordination.v1beta1.LeaseList

/// LeaseList is a list of Lease objects.
#[derive(Clone, Debug, Default, PartialEq)]
pub struct LeaseList {
    /// Items is a list of schema objects.
    pub items: Vec<::v1_12::api::coordination::v1beta1::Lease>,

    /// Standard list metadata. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata
    pub metadata: Option<::v1_12::apimachinery::pkg::apis::meta::v1::ListMeta>,
}

impl ::TypeMeta for LeaseList {
...
impl<'de> ::serde::Deserialize<'de> for LeaseList {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            type Value = LeaseList;

            fn expecting(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
                write!(f, "struct LeaseList")
            }

            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<::v1_12::api::coordination::v1beta1::Lease>> = None;
...
impl ::serde::Serialize for LeaseList {
