...
impl PriorityClass {
    ...
    pub fn create_scheduling_v1beta1_priority_class(
        body: &::v1_12::api::scheduling::v1beta1::PriorityClass,
        pretty: Option<&str>,
...
pub enum CreateSchedulingV1beta1PriorityClassResponse {
    Ok(::v1_12::api::scheduling::v1beta1::PriorityClass),
    Created(::v1_12::api::scheduling::v1beta1::PriorityClass),
    Accepted(::v1_12::api::scheduling::v1beta1::PriorityClass),
    Unauthorized,
    Other,
}
...
pub enum DeleteSchedulingV1beta1CollectionPriorityClassResponse {
    ...
    OkValue(::v1_12::api::scheduling::v1beta1::PriorityClass),
    Unauthorized,
    Other,
}
    ...
    fn try_from_parts(status_code: ::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), ::ResponseError> {
        match status_code {
            ...
            ::http::StatusCode::ACCEPTED => {
                ...
                Ok((DeleteSchedulingV1beta1PriorityClassResponse::Accepted(result), buf.len()))
            },
...
pub enum ListSchedulingV1beta1PriorityClassResponse {
    Ok(::v1_12::api::scheduling::v1beta1::PriorityClassList),
    Unauthorized,
    Other,
}
...
impl ::TypeMeta for PriorityClass {
