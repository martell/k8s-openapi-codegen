// Generated from definition io.k8s.api.extensions.v1beta1.ReplicaSetList

/// ReplicaSetList is a collection of ReplicaSets.
#[derive(Clone, Debug, Default, PartialEq)]
pub struct ReplicaSetList {
    /// List of ReplicaSets. More info: https://kubernetes.io/docs/concepts/workloads/controllers/replicationcontroller
    pub items: Vec<::v1_12::api::extensions::v1beta1::ReplicaSet>,

    /// Standard list metadata. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#types-kinds
    pub metadata: Option<::v1_12::apimachinery::pkg::apis::meta::v1::ListMeta>,
}

impl ::TypeMeta for ReplicaSetList {
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<::v1_12::api::extensions::v1beta1::ReplicaSet>> = None;
