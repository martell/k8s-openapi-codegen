...
pub struct NetworkPolicy {
    ...
    pub spec: Option<::v1_12::api::extensions::v1beta1::NetworkPolicySpec>,
}
...
impl NetworkPolicy {
    ...
    pub fn create_extensions_v1beta1_namespaced_network_policy(
        namespace: &str,
        body: &::v1_12::api::extensions::v1beta1::NetworkPolicy,
        pretty: Option<&str>,
...
pub enum CreateExtensionsV1beta1NamespacedNetworkPolicyResponse {
    Ok(::v1_12::api::extensions::v1beta1::NetworkPolicy),
    Created(::v1_12::api::extensions::v1beta1::NetworkPolicy),
    Accepted(::v1_12::api::extensions::v1beta1::NetworkPolicy),
    Unauthorized,
    Other,
}
...
pub enum DeleteExtensionsV1beta1CollectionNamespacedNetworkPolicyResponse {
    ...
    OkValue(::v1_12::api::extensions::v1beta1::NetworkPolicy),
    Unauthorized,
    Other,
}
    ...
    fn try_from_parts(status_code: ::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), ::ResponseError> {
        match status_code {
            ...
            ::http::StatusCode::ACCEPTED => {
                ...
                Ok((DeleteExtensionsV1beta1NamespacedNetworkPolicyResponse::Accepted(result), buf.len()))
            },
...
pub enum ListExtensionsV1beta1NamespacedNetworkPolicyResponse {
    Ok(::v1_12::api::extensions::v1beta1::NetworkPolicyList),
    Unauthorized,
    Other,
}
