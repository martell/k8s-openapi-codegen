// Generated from definition io.k8s.api.autoscaling.v2beta1.HorizontalPodAutoscalerList

/// HorizontalPodAutoscaler is a list of horizontal pod autoscaler objects.
#[derive(Clone, Debug, Default, PartialEq)]
pub struct HorizontalPodAutoscalerList {
    /// items is the list of horizontal pod autoscaler objects.
    pub items: Vec<::v1_12::api::autoscaling::v2beta1::HorizontalPodAutoscaler>,

    /// metadata is the standard list metadata.
    pub metadata: Option<::v1_12::apimachinery::pkg::apis::meta::v1::ListMeta>,
}

impl ::TypeMeta for HorizontalPodAutoscalerList {
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<::v1_12::api::autoscaling::v2beta1::HorizontalPodAutoscaler>> = None;
