...
pub struct HorizontalPodAutoscaler {
    ...
    pub spec: Option<::v1_12::api::autoscaling::v2beta1::HorizontalPodAutoscalerSpec>,

    /// status is the current information about the autoscaler.
    pub status: Option<::v1_12::api::autoscaling::v2beta1::HorizontalPodAutoscalerStatus>,
}
...
impl HorizontalPodAutoscaler {
    ...
    pub fn create_autoscaling_v2beta1_namespaced_horizontal_pod_autoscaler(
        namespace: &str,
        body: &::v1_12::api::autoscaling::v2beta1::HorizontalPodAutoscaler,
        pretty: Option<&str>,
...
pub enum CreateAutoscalingV2beta1NamespacedHorizontalPodAutoscalerResponse {
    Ok(::v1_12::api::autoscaling::v2beta1::HorizontalPodAutoscaler),
    Created(::v1_12::api::autoscaling::v2beta1::HorizontalPodAutoscaler),
    Accepted(::v1_12::api::autoscaling::v2beta1::HorizontalPodAutoscaler),
    Unauthorized,
    Other,
}
...
pub enum DeleteAutoscalingV2beta1CollectionNamespacedHorizontalPodAutoscalerResponse {
    ...
    OkValue(::v1_12::api::autoscaling::v2beta1::HorizontalPodAutoscaler),
    Unauthorized,
    Other,
}
    ...
    fn try_from_parts(status_code: ::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), ::ResponseError> {
        match status_code {
            ...
            ::http::StatusCode::ACCEPTED => {
                ...
                Ok((DeleteAutoscalingV2beta1NamespacedHorizontalPodAutoscalerResponse::Accepted(result), buf.len()))
            },
...
pub enum ListAutoscalingV2beta1HorizontalPodAutoscalerForAllNamespacesResponse {
    Ok(::v1_12::api::autoscaling::v2beta1::HorizontalPodAutoscalerList),
    Unauthorized,
    Other,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<::v1_12::api::autoscaling::v2beta1::HorizontalPodAutoscalerSpec> = None;
                let mut value_status: Option<::v1_12::api::autoscaling::v2beta1::HorizontalPodAutoscalerStatus> = None;
