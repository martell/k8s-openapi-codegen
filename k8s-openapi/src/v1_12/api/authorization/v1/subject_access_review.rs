...
impl SubjectAccessReview {
    ...
    pub fn create_authorization_v1_subject_access_review(
        body: &::v1_12::api::authorization::v1::SubjectAccessReview,
        pretty: Option<&str>,
...
pub enum CreateAuthorizationV1SubjectAccessReviewResponse {
    Ok(::v1_12::api::authorization::v1::SubjectAccessReview),
    Created(::v1_12::api::authorization::v1::SubjectAccessReview),
    Accepted(::v1_12::api::authorization::v1::SubjectAccessReview),
    Unauthorized,
    Other,
}
...
impl ::TypeMeta for SubjectAccessReview {
