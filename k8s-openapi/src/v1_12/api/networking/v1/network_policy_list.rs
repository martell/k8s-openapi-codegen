// Generated from definition io.k8s.api.networking.v1.NetworkPolicyList

/// NetworkPolicyList is a list of NetworkPolicy objects.
#[derive(Clone, Debug, Default, PartialEq)]
pub struct NetworkPolicyList {
    /// Items is a list of schema objects.
    pub items: Vec<::v1_12::api::networking::v1::NetworkPolicy>,

    /// Standard list metadata. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata
    pub metadata: Option<::v1_12::apimachinery::pkg::apis::meta::v1::ListMeta>,
}

impl ::TypeMeta for NetworkPolicyList {
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<::v1_12::api::networking::v1::NetworkPolicy>> = None;
