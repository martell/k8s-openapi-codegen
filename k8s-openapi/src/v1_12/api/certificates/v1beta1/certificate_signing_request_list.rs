// Generated from definition io.k8s.api.certificates.v1beta1.CertificateSigningRequestList

#[derive(Clone, Debug, Default, PartialEq)]
pub struct CertificateSigningRequestList {
    pub items: Vec<::v1_12::api::certificates::v1beta1::CertificateSigningRequest>,

    pub metadata: Option<::v1_12::apimachinery::pkg::apis::meta::v1::ListMeta>,
}

impl ::TypeMeta for CertificateSigningRequestList {
...
impl<'de> ::serde::Deserialize<'de> for CertificateSigningRequestList {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            type Value = CertificateSigningRequestList;

            fn expecting(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
                write!(f, "struct CertificateSigningRequestList")
            }

            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<::v1_12::api::certificates::v1beta1::CertificateSigningRequest>> = None;
...
impl ::serde::Serialize for CertificateSigningRequestList {
