...
pub struct DeploymentRollback {
    ...
    pub rollback_to: ::v1_10::api::apps::v1beta1::RollbackConfig,
...
impl DeploymentRollback {
    ...
    pub fn create_apps_v1beta1_namespaced_deployment_rollback(
        name: &str,
        namespace: &str,
        body: &::v1_10::api::apps::v1beta1::DeploymentRollback,
        pretty: Option<&str>,
...
pub enum CreateAppsV1beta1NamespacedDeploymentRollbackResponse {
    ...
    Created(::v1_10::apimachinery::pkg::apis::meta::v1::Status),
    Accepted(::v1_10::apimachinery::pkg::apis::meta::v1::Status),
    Unauthorized,
    Other,
}
