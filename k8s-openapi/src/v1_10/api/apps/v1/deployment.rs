...
pub struct Deployment {
    ...
    pub spec: Option<::v1_10::api::apps::v1::DeploymentSpec>,

    /// Most recently observed status of the Deployment.
    pub status: Option<::v1_10::api::apps::v1::DeploymentStatus>,
}
...
impl Deployment {
    ...
    pub fn create_apps_v1_namespaced_deployment(
        namespace: &str,
        body: &::v1_10::api::apps::v1::Deployment,
        pretty: Option<&str>,
...
pub enum CreateAppsV1NamespacedDeploymentResponse {
    Ok(::v1_10::api::apps::v1::Deployment),
    Created(::v1_10::api::apps::v1::Deployment),
    Accepted(::v1_10::api::apps::v1::Deployment),
    Unauthorized,
    Other,
}
...
pub enum DeleteAppsV1CollectionNamespacedDeploymentResponse {
    ...
    OkValue(::v1_10::api::apps::v1::Deployment),
    Unauthorized,
    Other,
}
...
pub enum ListAppsV1DeploymentForAllNamespacesResponse {
    Ok(::v1_10::api::apps::v1::DeploymentList),
    Unauthorized,
    Other,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<::v1_10::api::apps::v1::DeploymentSpec> = None;
                let mut value_status: Option<::v1_10::api::apps::v1::DeploymentStatus> = None;
