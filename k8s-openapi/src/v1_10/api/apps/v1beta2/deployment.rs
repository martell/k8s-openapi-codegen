...
pub struct Deployment {
    ...
    pub spec: Option<::v1_10::api::apps::v1beta2::DeploymentSpec>,

    /// Most recently observed status of the Deployment.
    pub status: Option<::v1_10::api::apps::v1beta2::DeploymentStatus>,
}
...
impl Deployment {
    ...
    pub fn create_apps_v1beta2_namespaced_deployment(
        namespace: &str,
        body: &::v1_10::api::apps::v1beta2::Deployment,
        pretty: Option<&str>,
...
pub enum CreateAppsV1beta2NamespacedDeploymentResponse {
    Ok(::v1_10::api::apps::v1beta2::Deployment),
    Created(::v1_10::api::apps::v1beta2::Deployment),
    Accepted(::v1_10::api::apps::v1beta2::Deployment),
    Unauthorized,
    Other,
}
...
pub enum DeleteAppsV1beta2CollectionNamespacedDeploymentResponse {
    ...
    OkValue(::v1_10::api::apps::v1beta2::Deployment),
    Unauthorized,
    Other,
}
...
pub enum ListAppsV1beta2DeploymentForAllNamespacesResponse {
    Ok(::v1_10::api::apps::v1beta2::DeploymentList),
    Unauthorized,
    Other,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<::v1_10::api::apps::v1beta2::DeploymentSpec> = None;
                let mut value_status: Option<::v1_10::api::apps::v1beta2::DeploymentStatus> = None;
