...
impl SubjectAccessReview {
    ...
    pub fn create_authorization_v1beta1_subject_access_review(
        body: &::v1_10::api::authorization::v1beta1::SubjectAccessReview,
        pretty: Option<&str>,
...
pub enum CreateAuthorizationV1beta1SubjectAccessReviewResponse {
    Ok(::v1_10::api::authorization::v1beta1::SubjectAccessReview),
    Created(::v1_10::api::authorization::v1beta1::SubjectAccessReview),
    Accepted(::v1_10::api::authorization::v1beta1::SubjectAccessReview),
    Unauthorized,
    Other,
}
