...
impl LocalSubjectAccessReview {
    ...
    pub fn create_authorization_v1_namespaced_local_subject_access_review(
        namespace: &str,
        body: &::v1_10::api::authorization::v1::LocalSubjectAccessReview,
        pretty: Option<&str>,
...
pub enum CreateAuthorizationV1NamespacedLocalSubjectAccessReviewResponse {
    Ok(::v1_10::api::authorization::v1::LocalSubjectAccessReview),
    Created(::v1_10::api::authorization::v1::LocalSubjectAccessReview),
    Accepted(::v1_10::api::authorization::v1::LocalSubjectAccessReview),
    Unauthorized,
    Other,
}
