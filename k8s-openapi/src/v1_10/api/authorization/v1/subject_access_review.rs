...
pub struct SubjectAccessReview {
    ...
    pub spec: ::v1_10::api::authorization::v1::SubjectAccessReviewSpec,
...
impl SubjectAccessReview {
    ...
    pub fn create_authorization_v1_subject_access_review(
        body: &::v1_10::api::authorization::v1::SubjectAccessReview,
        pretty: Option<&str>,
...
pub enum CreateAuthorizationV1SubjectAccessReviewResponse {
    Ok(::v1_10::api::authorization::v1::SubjectAccessReview),
    Created(::v1_10::api::authorization::v1::SubjectAccessReview),
    Accepted(::v1_10::api::authorization::v1::SubjectAccessReview),
    Unauthorized,
    Other,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<::v1_10::api::authorization::v1::SubjectAccessReviewSpec> = None;
