// Generated from definition io.k8s.api.policy.v1beta1.PodDisruptionBudgetList

/// PodDisruptionBudgetList is a collection of PodDisruptionBudgets.
#[derive(Clone, Debug, Default, PartialEq)]
pub struct PodDisruptionBudgetList {
    pub items: Vec<::v1_10::api::policy::v1beta1::PodDisruptionBudget>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<::v1_10::api::policy::v1beta1::PodDisruptionBudget>> = None;
