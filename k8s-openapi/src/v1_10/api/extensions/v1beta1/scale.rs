...
pub struct Scale {
    ...
    pub spec: Option<::v1_10::api::extensions::v1beta1::ScaleSpec>,

    /// current status of the scale. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status. Read-only.
    pub status: Option<::v1_10::api::extensions::v1beta1::ScaleStatus>,
}
...
pub enum PatchExtensionsV1beta1NamespacedDeploymentScaleResponse {
    Ok(::v1_10::api::extensions::v1beta1::Scale),
    Unauthorized,
    Other,
}
...
impl Scale {
    ...
    pub fn replace_extensions_v1beta1_namespaced_deployment_scale(
        name: &str,
        namespace: &str,
        body: &::v1_10::api::extensions::v1beta1::Scale,
        pretty: Option<&str>,
    ) -> Result<::http::Request<Vec<u8>>, ::RequestError> {
        let __url = format!("/apis/extensions/v1beta1/namespaces/{namespace}/deployments/{name}/scale?", name = name, namespace = namespace);
        let mut __query_pairs = ::url::form_urlencoded::Serializer::new(__url);
...
pub enum ReplaceExtensionsV1beta1NamespacedDeploymentScaleResponse {
    Ok(::v1_10::api::extensions::v1beta1::Scale),
    Created(::v1_10::api::extensions::v1beta1::Scale),
    Unauthorized,
    Other,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<::v1_10::api::extensions::v1beta1::ScaleSpec> = None;
                let mut value_status: Option<::v1_10::api::extensions::v1beta1::ScaleStatus> = None;
