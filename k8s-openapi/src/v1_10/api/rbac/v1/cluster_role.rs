...
pub struct ClusterRole {
    ...
    pub aggregation_rule: Option<::v1_10::api::rbac::v1::AggregationRule>,
...
impl ClusterRole {
    ...
    ///
    /// Use [`CreateRbacAuthorizationV1ClusterRoleResponse`](./enum.CreateRbacAuthorizationV1ClusterRoleResponse.html) to parse the HTTP response.
    ///
    /// # Arguments
    ///
    /// * `body`
    ...
    pub fn create_rbac_authorization_v1_cluster_role(
        body: &::v1_10::api::rbac::v1::ClusterRole,
        pretty: Option<&str>,
...
pub enum CreateRbacAuthorizationV1ClusterRoleResponse {
    Ok(::v1_10::api::rbac::v1::ClusterRole),
    Created(::v1_10::api::rbac::v1::ClusterRole),
    Accepted(::v1_10::api::rbac::v1::ClusterRole),
    Unauthorized,
    Other,
}

impl ::Response for CreateRbacAuthorizationV1ClusterRoleResponse {
    fn try_from_parts(status_code: ::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), ::ResponseError> {
        match status_code {
            ::http::StatusCode::OK => {
                ...
                Ok((CreateRbacAuthorizationV1ClusterRoleResponse::Ok(result), buf.len()))
            },
            ::http::StatusCode::CREATED => {
                ...
                Ok((CreateRbacAuthorizationV1ClusterRoleResponse::Created(result), buf.len()))
            },
            ::http::StatusCode::ACCEPTED => {
                ...
                Ok((CreateRbacAuthorizationV1ClusterRoleResponse::Accepted(result), buf.len()))
            },
            ::http::StatusCode::UNAUTHORIZED => Ok((CreateRbacAuthorizationV1ClusterRoleResponse::Unauthorized, 0)),
            _ => Ok((CreateRbacAuthorizationV1ClusterRoleResponse::Other, 0)),
        }
    }
}
...
impl ClusterRole {
    ...
    ///
    /// Use [`DeleteRbacAuthorizationV1ClusterRoleResponse`](./enum.DeleteRbacAuthorizationV1ClusterRoleResponse.html) to parse the HTTP response.
    ///
    /// # Arguments
    ///
    /// * `name`
...
pub enum DeleteRbacAuthorizationV1ClusterRoleResponse {
    ...
    OkValue(::v1_10::api::rbac::v1::ClusterRole),
    Unauthorized,
    Other,
}

impl ::Response for DeleteRbacAuthorizationV1ClusterRoleResponse {
    fn try_from_parts(status_code: ::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), ::ResponseError> {
        match status_code {
            ::http::StatusCode::OK => {
                ...
                if is_status {
                    ...
                    Ok((DeleteRbacAuthorizationV1ClusterRoleResponse::OkStatus(result), buf.len()))
                }
                else {
                    let result = ::serde::Deserialize::deserialize(::serde_json::Value::Object(result));
                    let result = result.map_err(::ResponseError::Json)?;
...
impl ClusterRole {
    ...
    ///
    /// Use [`DeleteRbacAuthorizationV1CollectionClusterRoleResponse`](./enum.DeleteRbacAuthorizationV1CollectionClusterRoleResponse.html) to parse the HTTP response.
    ///
    /// # Arguments
    ///
    /// * `continue_`
    ...
    pub fn delete_rbac_authorization_v1_collection_cluster_role(
...
impl ::Response for DeleteRbacAuthorizationV1CollectionClusterRoleResponse {
    fn try_from_parts(status_code: ::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), ::ResponseError> {
        match status_code {
            ::http::StatusCode::OK => {
                let result: ::serde_json::Map<String, ::serde_json::Value> = match ::serde_json::from_slice(buf) {
                ...
                if is_status {
                    let result = ::serde::Deserialize::deserialize(::serde_json::Value::Object(result));
                    let result = result.map_err(::ResponseError::Json)?;
                    Ok((DeleteRbacAuthorizationV1CollectionClusterRoleResponse::OkStatus(result), buf.len()))
                }
                else {
                    let result = ::serde::Deserialize::deserialize(::serde_json::Value::Object(result));
                    let result = result.map_err(::ResponseError::Json)?;
                    Ok((DeleteRbacAuthorizationV1CollectionClusterRoleResponse::OkValue(result), buf.len()))
                }
            },
            ::http::StatusCode::UNAUTHORIZED => Ok((DeleteRbacAuthorizationV1CollectionClusterRoleResponse::Unauthorized, 0)),
            _ => Ok((DeleteRbacAuthorizationV1CollectionClusterRoleResponse::Other, 0)),
        }
    }
}
...
impl ClusterRole {
    ...
    ///
    /// Use [`ListRbacAuthorizationV1ClusterRoleResponse`](./enum.ListRbacAuthorizationV1ClusterRoleResponse.html) to parse the HTTP response.
    ///
    /// # Arguments
    ///
    /// * `continue_`
    ...
    ///
    ///     Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
    pub fn list_rbac_authorization_v1_cluster_role(
        continue_: Option<&str>,
        field_selector: Option<&str>,
        include_uninitialized: Option<bool>,
        label_selector: Option<&str>,
...
pub enum ListRbacAuthorizationV1ClusterRoleResponse {
    Ok(::v1_10::api::rbac::v1::ClusterRoleList),
    Unauthorized,
    Other,
}

impl ::Response for ListRbacAuthorizationV1ClusterRoleResponse {
    fn try_from_parts(status_code: ::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), ::ResponseError> {
        match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
                ...
                Ok((ListRbacAuthorizationV1ClusterRoleResponse::Ok(result), buf.len()))
            },
            ::http::StatusCode::UNAUTHORIZED => Ok((ListRbacAuthorizationV1ClusterRoleResponse::Unauthorized, 0)),
            _ => Ok((ListRbacAuthorizationV1ClusterRoleResponse::Other, 0)),
        }
    }
}
...
impl ClusterRole {
    ...
    ///
    /// Use [`PatchRbacAuthorizationV1ClusterRoleResponse`](./enum.PatchRbacAuthorizationV1ClusterRoleResponse.html) to parse the HTTP response.
    ///
    /// # Arguments
    ///
    /// * `name`
...
impl ::Response for PatchRbacAuthorizationV1ClusterRoleResponse {
    fn try_from_parts(status_code: ::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), ::ResponseError> {
        match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
                ...
                Ok((PatchRbacAuthorizationV1ClusterRoleResponse::Ok(result), buf.len()))
            },
            ::http::StatusCode::UNAUTHORIZED => Ok((PatchRbacAuthorizationV1ClusterRoleResponse::Unauthorized, 0)),
            _ => Ok((PatchRbacAuthorizationV1ClusterRoleResponse::Other, 0)),
        }
    }
}
...
impl ClusterRole {
    ...
    ///
    /// Use [`ReadRbacAuthorizationV1ClusterRoleResponse`](./enum.ReadRbacAuthorizationV1ClusterRoleResponse.html) to parse the HTTP response.
    ///
    /// # Arguments
    ///
    /// * `name`
    ...
    ///
    ///     If 'true', then the output is pretty printed.
    pub fn read_rbac_authorization_v1_cluster_role(
        name: &str,
        pretty: Option<&str>,
    ) -> Result<::http::Request<Vec<u8>>, ::RequestError> {
        let __url = format!("/apis/rbac.authorization.k8s.io/v1/clusterroles/{name}?", name = name);
...
impl ::Response for ReadRbacAuthorizationV1ClusterRoleResponse {
    fn try_from_parts(status_code: ::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), ::ResponseError> {
        match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
                ...
                Ok((ReadRbacAuthorizationV1ClusterRoleResponse::Ok(result), buf.len()))
            },
            ::http::StatusCode::UNAUTHORIZED => Ok((ReadRbacAuthorizationV1ClusterRoleResponse::Unauthorized, 0)),
            _ => Ok((ReadRbacAuthorizationV1ClusterRoleResponse::Other, 0)),
        }
    }
}
...
impl ClusterRole {
    ...
    ///
    /// Use [`ReplaceRbacAuthorizationV1ClusterRoleResponse`](./enum.ReplaceRbacAuthorizationV1ClusterRoleResponse.html) to parse the HTTP response.
    ///
    /// # Arguments
    ///
    /// * `name`
...
impl ::Response for ReplaceRbacAuthorizationV1ClusterRoleResponse {
    fn try_from_parts(status_code: ::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), ::ResponseError> {
        match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
                ...
                Ok((ReplaceRbacAuthorizationV1ClusterRoleResponse::Ok(result), buf.len()))
            },
            ::http::StatusCode::CREATED => {
                let result = match ::serde_json::from_slice(buf) {
                    Ok(value) => value,
                ...
                Ok((ReplaceRbacAuthorizationV1ClusterRoleResponse::Created(result), buf.len()))
            },
            ::http::StatusCode::UNAUTHORIZED => Ok((ReplaceRbacAuthorizationV1ClusterRoleResponse::Unauthorized, 0)),
            _ => Ok((ReplaceRbacAuthorizationV1ClusterRoleResponse::Other, 0)),
        }
    }
}
...
impl ClusterRole {
    ...
    ///
    ///     Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
    pub fn watch_rbac_authorization_v1_cluster_role(
        name: &str,
        continue_: Option<&str>,
        field_selector: Option<&str>,
        include_uninitialized: Option<bool>,
...
impl ::Response for WatchRbacAuthorizationV1ClusterRoleResponse {
    fn try_from_parts(status_code: ::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), ::ResponseError> {
        match status_code {
            ::http::StatusCode::OK => {
                ...
                Ok((WatchRbacAuthorizationV1ClusterRoleResponse::Ok(result), byte_offset))
            },
            ::http::StatusCode::UNAUTHORIZED => Ok((WatchRbacAuthorizationV1ClusterRoleResponse::Unauthorized, 0)),
            _ => Ok((WatchRbacAuthorizationV1ClusterRoleResponse::Other, 0)),
        }
    }
}
...
impl ClusterRole {
    ...
    ///
    ///     Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
    pub fn watch_rbac_authorization_v1_cluster_role_list(
        continue_: Option<&str>,
        field_selector: Option<&str>,
        include_uninitialized: Option<bool>,
        label_selector: Option<&str>,
...
impl ::Response for WatchRbacAuthorizationV1ClusterRoleListResponse {
    fn try_from_parts(status_code: ::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), ::ResponseError> {
        match status_code {
            ::http::StatusCode::OK => {
                let mut deserializer = ::serde_json::Deserializer::from_slice(buf).into_iter();
                ...
                Ok((WatchRbacAuthorizationV1ClusterRoleListResponse::Ok(result), byte_offset))
            },
            ::http::StatusCode::UNAUTHORIZED => Ok((WatchRbacAuthorizationV1ClusterRoleListResponse::Unauthorized, 0)),
            _ => Ok((WatchRbacAuthorizationV1ClusterRoleListResponse::Other, 0)),
        }
    }
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_aggregation_rule: Option<::v1_10::api::rbac::v1::AggregationRule> = None;
