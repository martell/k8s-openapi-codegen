...
impl Role {
    ...
    pub fn create_rbac_authorization_v1beta1_namespaced_role(
        namespace: &str,
        body: &::v1_10::api::rbac::v1beta1::Role,
        pretty: Option<&str>,
...
pub enum CreateRbacAuthorizationV1beta1NamespacedRoleResponse {
    Ok(::v1_10::api::rbac::v1beta1::Role),
    Created(::v1_10::api::rbac::v1beta1::Role),
    Accepted(::v1_10::api::rbac::v1beta1::Role),
    Unauthorized,
    Other,
}
...
pub enum DeleteRbacAuthorizationV1beta1CollectionNamespacedRoleResponse {
    ...
    OkValue(::v1_10::api::rbac::v1beta1::Role),
    Unauthorized,
    Other,
}
...
pub enum ListRbacAuthorizationV1beta1NamespacedRoleResponse {
    Ok(::v1_10::api::rbac::v1beta1::RoleList),
    Unauthorized,
    Other,
}
