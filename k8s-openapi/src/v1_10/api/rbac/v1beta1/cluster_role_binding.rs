...
pub struct ClusterRoleBinding {
    ...
    pub role_ref: ::v1_10::api::rbac::v1beta1::RoleRef,

    /// Subjects holds references to the objects the role applies to.
    pub subjects: Vec<::v1_10::api::rbac::v1beta1::Subject>,
}
...
impl ClusterRoleBinding {
    ...
    pub fn create_rbac_authorization_v1beta1_cluster_role_binding(
        body: &::v1_10::api::rbac::v1beta1::ClusterRoleBinding,
        pretty: Option<&str>,
...
pub enum CreateRbacAuthorizationV1beta1ClusterRoleBindingResponse {
    Ok(::v1_10::api::rbac::v1beta1::ClusterRoleBinding),
    Created(::v1_10::api::rbac::v1beta1::ClusterRoleBinding),
    Accepted(::v1_10::api::rbac::v1beta1::ClusterRoleBinding),
    Unauthorized,
    Other,
}
...
pub enum DeleteRbacAuthorizationV1beta1ClusterRoleBindingResponse {
    ...
    OkValue(::v1_10::api::rbac::v1beta1::ClusterRoleBinding),
    Unauthorized,
    Other,
}
...
pub enum ListRbacAuthorizationV1beta1ClusterRoleBindingResponse {
    Ok(::v1_10::api::rbac::v1beta1::ClusterRoleBindingList),
    Unauthorized,
    Other,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                ...
                let mut value_role_ref: Option<::v1_10::api::rbac::v1beta1::RoleRef> = None;
                let mut value_subjects: Option<Vec<::v1_10::api::rbac::v1beta1::Subject>> = None;
