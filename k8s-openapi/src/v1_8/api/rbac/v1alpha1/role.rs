...
pub struct Role {
    ...
    pub rules: Vec<::v1_8::api::rbac::v1alpha1::PolicyRule>,
}
...
impl Role {
    ...
    pub fn create_rbac_authorization_v1alpha1_namespaced_role(
        namespace: &str,
        body: &::v1_8::api::rbac::v1alpha1::Role,
        pretty: Option<&str>,
...
pub enum CreateRbacAuthorizationV1alpha1NamespacedRoleResponse {
    Ok(::v1_8::api::rbac::v1alpha1::Role),
    Unauthorized,
    Other,
}
...
pub enum DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleResponse {
    ...
    OkValue(::v1_8::api::rbac::v1alpha1::Role),
    Unauthorized,
    Other,
}
...
pub enum ListRbacAuthorizationV1alpha1NamespacedRoleResponse {
    Ok(::v1_8::api::rbac::v1alpha1::RoleList),
    Unauthorized,
    Other,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                ...
                let mut value_rules: Option<Vec<::v1_8::api::rbac::v1alpha1::PolicyRule>> = None;
