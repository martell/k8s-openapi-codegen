...
pub struct LimitRange {
    ...
    pub spec: Option<::v1_8::api::core::v1::LimitRangeSpec>,
}
...
impl LimitRange {
    ...
    pub fn create_core_v1_namespaced_limit_range(
        namespace: &str,
        body: &::v1_8::api::core::v1::LimitRange,
        pretty: Option<&str>,
...
pub enum DeleteCoreV1CollectionNamespacedLimitRangeResponse {
    ...
    OkValue(::v1_8::api::core::v1::LimitRange),
    Unauthorized,
    Other,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<::v1_8::api::core::v1::LimitRangeSpec> = None;
