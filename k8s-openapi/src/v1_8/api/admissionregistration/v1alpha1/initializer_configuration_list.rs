// Generated from definition io.k8s.api.admissionregistration.v1alpha1.InitializerConfigurationList

/// InitializerConfigurationList is a list of InitializerConfiguration.
#[derive(Clone, Debug, Default, PartialEq)]
pub struct InitializerConfigurationList {
    /// List of InitializerConfiguration.
    pub items: Vec<::v1_8::api::admissionregistration::v1alpha1::InitializerConfiguration>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<::v1_8::api::admissionregistration::v1alpha1::InitializerConfiguration>> = None;
