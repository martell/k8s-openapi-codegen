// Generated from definition io.k8s.kubernetes.pkg.api.v1.NamespaceList

/// NamespaceList is a list of Namespaces.
#[derive(Clone, Debug, Default, PartialEq)]
pub struct NamespaceList {
    /// Items is the list of Namespace objects in the list. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/
    pub items: Vec<::v1_7::kubernetes::pkg::api::v1::Namespace>,

    /// Standard list metadata. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#types-kinds
    pub metadata: Option<::v1_7::apimachinery::pkg::apis::meta::v1::ListMeta>,
}

impl ::Resource for NamespaceList {
...
impl<'de> ::serde::Deserialize<'de> for NamespaceList {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn expecting(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
                write!(f, "struct NamespaceList")
            }

            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<::v1_7::kubernetes::pkg::api::v1::Namespace>> = None;
