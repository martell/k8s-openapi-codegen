// Generated from definition io.k8s.kubernetes.pkg.api.v1.ServiceAccountList

/// ServiceAccountList is a list of ServiceAccount objects
#[derive(Clone, Debug, Default, PartialEq)]
pub struct ServiceAccountList {
    /// List of ServiceAccounts. More info: https://kubernetes.io/docs/tasks/configure-pod-container/configure-service-account/
    pub items: Vec<::v1_7::kubernetes::pkg::api::v1::ServiceAccount>,

    /// Standard list metadata. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#types-kinds
    pub metadata: Option<::v1_7::apimachinery::pkg::apis::meta::v1::ListMeta>,
}

impl ::Resource for ServiceAccountList {
...
impl<'de> ::serde::Deserialize<'de> for ServiceAccountList {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn expecting(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
                write!(f, "struct ServiceAccountList")
            }

            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<::v1_7::kubernetes::pkg::api::v1::ServiceAccount>> = None;
