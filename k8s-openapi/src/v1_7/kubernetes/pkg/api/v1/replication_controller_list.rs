// Generated from definition io.k8s.kubernetes.pkg.api.v1.ReplicationControllerList

/// ReplicationControllerList is a collection of replication controllers.
#[derive(Clone, Debug, Default, PartialEq)]
pub struct ReplicationControllerList {
    /// List of replication controllers. More info: https://kubernetes.io/docs/concepts/workloads/controllers/replicationcontroller
    pub items: Vec<::v1_7::kubernetes::pkg::api::v1::ReplicationController>,

    /// Standard list metadata. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#types-kinds
    pub metadata: Option<::v1_7::apimachinery::pkg::apis::meta::v1::ListMeta>,
}

impl ::Resource for ReplicationControllerList {
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<::v1_7::kubernetes::pkg::api::v1::ReplicationController>> = None;
