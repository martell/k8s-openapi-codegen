// Generated from definition io.k8s.kubernetes.pkg.api.v1.ComponentStatusList

/// Status of all the conditions for the component as a list of ComponentStatus objects.
#[derive(Clone, Debug, Default, PartialEq)]
pub struct ComponentStatusList {
    /// List of ComponentStatus objects.
    pub items: Vec<::v1_7::kubernetes::pkg::api::v1::ComponentStatus>,

    /// Standard list metadata. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#types-kinds
    pub metadata: Option<::v1_7::apimachinery::pkg::apis::meta::v1::ListMeta>,
}

impl ::Resource for ComponentStatusList {
...
impl<'de> ::serde::Deserialize<'de> for ComponentStatusList {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn expecting(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
                write!(f, "struct ComponentStatusList")
            }

            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<::v1_7::kubernetes::pkg::api::v1::ComponentStatus>> = None;
