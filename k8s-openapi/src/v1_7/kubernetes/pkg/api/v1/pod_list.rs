// Generated from definition io.k8s.kubernetes.pkg.api.v1.PodList

/// PodList is a list of Pods.
#[derive(Clone, Debug, Default, PartialEq)]
pub struct PodList {
    /// List of pods. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md
    pub items: Vec<::v1_7::kubernetes::pkg::api::v1::Pod>,
...
impl<'de> ::serde::Deserialize<'de> for PodList {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn expecting(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
                write!(f, "struct PodList")
            }

            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<::v1_7::kubernetes::pkg::api::v1::Pod>> = None;
