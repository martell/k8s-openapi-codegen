// Generated from definition io.k8s.kubernetes.pkg.api.v1.PersistentVolumeClaimList

/// PersistentVolumeClaimList is a list of PersistentVolumeClaim items.
#[derive(Clone, Debug, Default, PartialEq)]
pub struct PersistentVolumeClaimList {
    /// A list of persistent volume claims. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistentvolumeclaims
    pub items: Vec<::v1_7::kubernetes::pkg::api::v1::PersistentVolumeClaim>,

    /// Standard list metadata. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#types-kinds
    pub metadata: Option<::v1_7::apimachinery::pkg::apis::meta::v1::ListMeta>,
}

impl ::Resource for PersistentVolumeClaimList {
...
impl<'de> ::serde::Deserialize<'de> for PersistentVolumeClaimList {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn expecting(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
                write!(f, "struct PersistentVolumeClaimList")
            }

            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<::v1_7::kubernetes::pkg::api::v1::PersistentVolumeClaim>> = None;
