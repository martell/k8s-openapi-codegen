// Generated from definition io.k8s.kubernetes.pkg.api.v1.PersistentVolumeList

/// PersistentVolumeList is a list of PersistentVolume items.
#[derive(Clone, Debug, Default, PartialEq)]
pub struct PersistentVolumeList {
    /// List of persistent volumes. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes
    pub items: Vec<::v1_7::kubernetes::pkg::api::v1::PersistentVolume>,

    /// Standard list metadata. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#types-kinds
    pub metadata: Option<::v1_7::apimachinery::pkg::apis::meta::v1::ListMeta>,
}

impl ::Resource for PersistentVolumeList {
...
impl<'de> ::serde::Deserialize<'de> for PersistentVolumeList {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn expecting(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
                write!(f, "struct PersistentVolumeList")
            }

            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<::v1_7::kubernetes::pkg::api::v1::PersistentVolume>> = None;
