// Generated from definition io.k8s.kubernetes.pkg.apis.apps.v1beta1.ControllerRevisionList

/// ControllerRevisionList is a resource containing a list of ControllerRevision objects.
#[derive(Clone, Debug, Default, PartialEq)]
pub struct ControllerRevisionList {
    /// Items is the list of ControllerRevisions
    pub items: Vec<::v1_7::kubernetes::pkg::apis::apps::v1beta1::ControllerRevision>,

    /// More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata
    pub metadata: Option<::v1_7::apimachinery::pkg::apis::meta::v1::ListMeta>,
}

impl ::Resource for ControllerRevisionList {
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<::v1_7::kubernetes::pkg::apis::apps::v1beta1::ControllerRevision>> = None;
