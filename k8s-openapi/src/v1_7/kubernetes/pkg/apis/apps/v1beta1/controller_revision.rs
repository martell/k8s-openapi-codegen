// Generated from definition io.k8s.kubernetes.pkg.apis.apps.v1beta1.ControllerRevision
...
pub struct ControllerRevision {
    ...
    pub data: Option<::v1_7::apimachinery::pkg::runtime::RawExtension>,
...
pub enum DeleteAppsV1beta1CollectionNamespacedControllerRevisionResponse {
    ...
    OkValue(::v1_7::kubernetes::pkg::apis::apps::v1beta1::ControllerRevision),
    Unauthorized,
    Other,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_data: Option<::v1_7::apimachinery::pkg::runtime::RawExtension> = None;
