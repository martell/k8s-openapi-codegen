// Generated from definition io.k8s.kubernetes.pkg.apis.apps.v1beta1.DeploymentList

/// DeploymentList is a list of Deployments.
#[derive(Clone, Debug, Default, PartialEq)]
pub struct DeploymentList {
    /// Items is the list of Deployments.
    pub items: Vec<::v1_7::kubernetes::pkg::apis::apps::v1beta1::Deployment>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<::v1_7::kubernetes::pkg::apis::apps::v1beta1::Deployment>> = None;
