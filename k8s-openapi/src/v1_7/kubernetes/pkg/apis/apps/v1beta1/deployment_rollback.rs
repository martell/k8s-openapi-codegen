// Generated from definition io.k8s.kubernetes.pkg.apis.apps.v1beta1.DeploymentRollback
...
pub struct DeploymentRollback {
    ...
    pub rollback_to: ::v1_7::kubernetes::pkg::apis::apps::v1beta1::RollbackConfig,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                ...
                let mut value_rollback_to: Option<::v1_7::kubernetes::pkg::apis::apps::v1beta1::RollbackConfig> = None;
