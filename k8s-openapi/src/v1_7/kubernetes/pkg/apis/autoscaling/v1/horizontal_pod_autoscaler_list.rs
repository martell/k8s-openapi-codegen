// Generated from definition io.k8s.kubernetes.pkg.apis.autoscaling.v1.HorizontalPodAutoscalerList

/// list of horizontal pod autoscaler objects.
#[derive(Clone, Debug, Default, PartialEq)]
pub struct HorizontalPodAutoscalerList {
    /// list of horizontal pod autoscaler objects.
    pub items: Vec<::v1_7::kubernetes::pkg::apis::autoscaling::v1::HorizontalPodAutoscaler>,

    /// Standard list metadata.
    pub metadata: Option<::v1_7::apimachinery::pkg::apis::meta::v1::ListMeta>,
}

impl ::Resource for HorizontalPodAutoscalerList {
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<::v1_7::kubernetes::pkg::apis::autoscaling::v1::HorizontalPodAutoscaler>> = None;
