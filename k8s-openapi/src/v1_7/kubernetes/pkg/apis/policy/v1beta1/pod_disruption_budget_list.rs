// Generated from definition io.k8s.kubernetes.pkg.apis.policy.v1beta1.PodDisruptionBudgetList

/// PodDisruptionBudgetList is a collection of PodDisruptionBudgets.
#[derive(Clone, Debug, Default, PartialEq)]
pub struct PodDisruptionBudgetList {
    pub items: Vec<::v1_7::kubernetes::pkg::apis::policy::v1beta1::PodDisruptionBudget>,

    pub metadata: Option<::v1_7::apimachinery::pkg::apis::meta::v1::ListMeta>,
}

impl ::Resource for PodDisruptionBudgetList {
...
impl<'de> ::serde::Deserialize<'de> for PodDisruptionBudgetList {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            type Value = PodDisruptionBudgetList;

            fn expecting(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
                write!(f, "struct PodDisruptionBudgetList")
            }

            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<::v1_7::kubernetes::pkg::apis::policy::v1beta1::PodDisruptionBudget>> = None;
...
impl ::serde::Serialize for PodDisruptionBudgetList {
