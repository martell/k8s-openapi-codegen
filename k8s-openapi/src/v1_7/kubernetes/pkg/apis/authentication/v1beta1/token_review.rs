// Generated from definition io.k8s.kubernetes.pkg.apis.authentication.v1beta1.TokenReview
...
pub struct TokenReview {
    ...
    pub spec: ::v1_7::kubernetes::pkg::apis::authentication::v1beta1::TokenReviewSpec,

    /// Status is filled in by the server and indicates whether the request can be authenticated.
    pub status: Option<::v1_7::kubernetes::pkg::apis::authentication::v1beta1::TokenReviewStatus>,
}
...
impl TokenReview {
    ...
    pub fn create_authentication_v1beta1_token_review(
        body: &::v1_7::kubernetes::pkg::apis::authentication::v1beta1::TokenReview,
        pretty: Option<&str>,
...
pub enum CreateAuthenticationV1beta1TokenReviewResponse {
    Ok(::v1_7::kubernetes::pkg::apis::authentication::v1beta1::TokenReview),
    Unauthorized,
    Other,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<::v1_7::kubernetes::pkg::apis::authentication::v1beta1::TokenReviewSpec> = None;
                let mut value_status: Option<::v1_7::kubernetes::pkg::apis::authentication::v1beta1::TokenReviewStatus> = None;
