// Generated from definition io.k8s.kubernetes.pkg.apis.storage.v1.StorageClassList

/// StorageClassList is a collection of storage classes.
#[derive(Clone, Debug, Default, PartialEq)]
pub struct StorageClassList {
    /// Items is the list of StorageClasses
    pub items: Vec<::v1_7::kubernetes::pkg::apis::storage::v1::StorageClass>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<::v1_7::kubernetes::pkg::apis::storage::v1::StorageClass>> = None;
