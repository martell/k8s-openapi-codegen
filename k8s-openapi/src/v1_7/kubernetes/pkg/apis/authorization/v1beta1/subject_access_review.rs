// Generated from definition io.k8s.kubernetes.pkg.apis.authorization.v1beta1.SubjectAccessReview
...
impl SubjectAccessReview {
    ...
    pub fn create_authorization_v1beta1_subject_access_review(
        body: &::v1_7::kubernetes::pkg::apis::authorization::v1beta1::SubjectAccessReview,
        pretty: Option<&str>,
...
pub enum CreateAuthorizationV1beta1SubjectAccessReviewResponse {
    Ok(::v1_7::kubernetes::pkg::apis::authorization::v1beta1::SubjectAccessReview),
    Unauthorized,
    Other,
}
