// Generated from definition io.k8s.kubernetes.pkg.apis.authorization.v1beta1.LocalSubjectAccessReview
...
pub struct LocalSubjectAccessReview {
    ...
    pub spec: ::v1_7::kubernetes::pkg::apis::authorization::v1beta1::SubjectAccessReviewSpec,
...
impl LocalSubjectAccessReview {
    ...
    pub fn create_authorization_v1beta1_namespaced_local_subject_access_review(
        namespace: &str,
        body: &::v1_7::kubernetes::pkg::apis::authorization::v1beta1::LocalSubjectAccessReview,
        pretty: Option<&str>,
...
pub enum CreateAuthorizationV1beta1NamespacedLocalSubjectAccessReviewResponse {
    Ok(::v1_7::kubernetes::pkg::apis::authorization::v1beta1::LocalSubjectAccessReview),
    Unauthorized,
    Other,
}

impl ::Response for CreateAuthorizationV1beta1NamespacedLocalSubjectAccessReviewResponse {
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<::v1_7::kubernetes::pkg::apis::authorization::v1beta1::SubjectAccessReviewSpec> = None;
                let mut value_status: Option<::v1_7::kubernetes::pkg::apis::authorization::v1beta1::SubjectAccessReviewStatus> = None;
