// Generated from definition io.k8s.kubernetes.pkg.apis.authorization.v1.SubjectAccessReview
...
pub struct SubjectAccessReview {
    ...
    pub spec: ::v1_7::kubernetes::pkg::apis::authorization::v1::SubjectAccessReviewSpec,
...
impl SubjectAccessReview {
    ...
    pub fn create_authorization_v1_subject_access_review(
        body: &::v1_7::kubernetes::pkg::apis::authorization::v1::SubjectAccessReview,
        pretty: Option<&str>,
...
pub enum CreateAuthorizationV1SubjectAccessReviewResponse {
    Ok(::v1_7::kubernetes::pkg::apis::authorization::v1::SubjectAccessReview),
    Unauthorized,
    Other,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<::v1_7::kubernetes::pkg::apis::authorization::v1::SubjectAccessReviewSpec> = None;
                let mut value_status: Option<::v1_7::kubernetes::pkg::apis::authorization::v1::SubjectAccessReviewStatus> = None;
