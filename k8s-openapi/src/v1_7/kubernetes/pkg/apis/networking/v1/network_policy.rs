// Generated from definition io.k8s.kubernetes.pkg.apis.networking.v1.NetworkPolicy
...
pub struct NetworkPolicy {
    ...
    pub spec: Option<::v1_7::kubernetes::pkg::apis::networking::v1::NetworkPolicySpec>,
}
...
impl NetworkPolicy {
    ...
    pub fn create_networking_v1_namespaced_network_policy(
        namespace: &str,
        body: &::v1_7::kubernetes::pkg::apis::networking::v1::NetworkPolicy,
        pretty: Option<&str>,
...
pub enum DeleteNetworkingV1CollectionNamespacedNetworkPolicyResponse {
    ...
    OkValue(::v1_7::kubernetes::pkg::apis::networking::v1::NetworkPolicy),
    Unauthorized,
    Other,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<::v1_7::kubernetes::pkg::apis::networking::v1::NetworkPolicySpec> = None;
