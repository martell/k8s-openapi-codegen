// Generated from definition io.k8s.kubernetes.pkg.apis.extensions.v1beta1.DeploymentList

/// DeploymentList is a list of Deployments.
#[derive(Clone, Debug, Default, PartialEq)]
pub struct DeploymentList {
    /// Items is the list of Deployments.
    pub items: Vec<::v1_7::kubernetes::pkg::apis::extensions::v1beta1::Deployment>,
...
impl<'de> ::serde::Deserialize<'de> for DeploymentList {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            type Value = DeploymentList;

            fn expecting(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
                write!(f, "struct DeploymentList")
            }

            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<::v1_7::kubernetes::pkg::apis::extensions::v1beta1::Deployment>> = None;
...
impl ::serde::Serialize for DeploymentList {
