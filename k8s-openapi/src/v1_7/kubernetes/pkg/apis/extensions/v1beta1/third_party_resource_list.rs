...
impl ::Resource for ThirdPartyResourceList {
...
impl<'de> ::serde::Deserialize<'de> for ThirdPartyResourceList {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            type Value = ThirdPartyResourceList;

            fn expecting(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
                write!(f, "struct ThirdPartyResourceList")
            }

            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<::v1_7::kubernetes::pkg::apis::extensions::v1beta1::ThirdPartyResource>> = None;
...
impl ::serde::Serialize for ThirdPartyResourceList {
