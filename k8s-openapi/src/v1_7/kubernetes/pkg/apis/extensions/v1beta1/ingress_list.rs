// Generated from definition io.k8s.kubernetes.pkg.apis.extensions.v1beta1.IngressList

/// IngressList is a collection of Ingress.
#[derive(Clone, Debug, Default, PartialEq)]
pub struct IngressList {
    /// Items is the list of Ingress.
    pub items: Vec<::v1_7::kubernetes::pkg::apis::extensions::v1beta1::Ingress>,
...
impl<'de> ::serde::Deserialize<'de> for IngressList {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn expecting(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
                write!(f, "struct IngressList")
            }

            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<::v1_7::kubernetes::pkg::apis::extensions::v1beta1::Ingress>> = None;
