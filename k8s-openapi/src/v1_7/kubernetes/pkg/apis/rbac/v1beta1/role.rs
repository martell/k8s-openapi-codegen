// Generated from definition io.k8s.kubernetes.pkg.apis.rbac.v1beta1.Role
...
impl Role {
    ...
    pub fn create_rbac_authorization_v1beta1_namespaced_role(
        namespace: &str,
        body: &::v1_7::kubernetes::pkg::apis::rbac::v1beta1::Role,
        pretty: Option<&str>,
...
pub enum DeleteRbacAuthorizationV1beta1CollectionNamespacedRoleResponse {
    ...
    OkValue(::v1_7::kubernetes::pkg::apis::rbac::v1beta1::Role),
    Unauthorized,
    Other,
}
