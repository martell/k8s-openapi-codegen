// Generated from definition io.k8s.kubernetes.pkg.apis.rbac.v1beta1.RoleList

/// RoleList is a collection of Roles
#[derive(Clone, Debug, Default, PartialEq)]
pub struct RoleList {
    /// Items is a list of Roles
    pub items: Vec<::v1_7::kubernetes::pkg::apis::rbac::v1beta1::Role>,
...
impl<'de> ::serde::Deserialize<'de> for RoleList {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn expecting(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
                write!(f, "struct RoleList")
            }

            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<::v1_7::kubernetes::pkg::apis::rbac::v1beta1::Role>> = None;
...
impl ::serde::Serialize for RoleList {
