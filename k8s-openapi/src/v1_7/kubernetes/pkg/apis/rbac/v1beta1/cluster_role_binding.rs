// Generated from definition io.k8s.kubernetes.pkg.apis.rbac.v1beta1.ClusterRoleBinding
...
impl ClusterRoleBinding {
    ...
    pub fn create_rbac_authorization_v1beta1_cluster_role_binding(
        body: &::v1_7::kubernetes::pkg::apis::rbac::v1beta1::ClusterRoleBinding,
        pretty: Option<&str>,
...
pub enum CreateRbacAuthorizationV1beta1ClusterRoleBindingResponse {
    Ok(::v1_7::kubernetes::pkg::apis::rbac::v1beta1::ClusterRoleBinding),
    Unauthorized,
    Other,
}
...
pub enum DeleteRbacAuthorizationV1beta1ClusterRoleBindingResponse {
    ...
    OkValue(::v1_7::kubernetes::pkg::apis::rbac::v1beta1::ClusterRoleBinding),
    Unauthorized,
    Other,
}
...
pub enum ListRbacAuthorizationV1beta1ClusterRoleBindingResponse {
    Ok(::v1_7::kubernetes::pkg::apis::rbac::v1beta1::ClusterRoleBindingList),
    Unauthorized,
    Other,
}
