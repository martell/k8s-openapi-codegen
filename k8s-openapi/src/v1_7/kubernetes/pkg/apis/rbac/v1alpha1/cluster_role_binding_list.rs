// Generated from definition io.k8s.kubernetes.pkg.apis.rbac.v1alpha1.ClusterRoleBindingList

/// ClusterRoleBindingList is a collection of ClusterRoleBindings
#[derive(Clone, Debug, Default, PartialEq)]
pub struct ClusterRoleBindingList {
    /// Items is a list of ClusterRoleBindings
    pub items: Vec<::v1_7::kubernetes::pkg::apis::rbac::v1alpha1::ClusterRoleBinding>,

    /// Standard object's metadata.
    pub metadata: Option<::v1_7::apimachinery::pkg::apis::meta::v1::ListMeta>,
}

impl ::Resource for ClusterRoleBindingList {
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<::v1_7::kubernetes::pkg::apis::rbac::v1alpha1::ClusterRoleBinding>> = None;
