// Generated from definition io.k8s.kubernetes.pkg.apis.rbac.v1alpha1.ClusterRoleList

/// ClusterRoleList is a collection of ClusterRoles
#[derive(Clone, Debug, Default, PartialEq)]
pub struct ClusterRoleList {
    /// Items is a list of ClusterRoles
    pub items: Vec<::v1_7::kubernetes::pkg::apis::rbac::v1alpha1::ClusterRole>,
...
impl<'de> ::serde::Deserialize<'de> for ClusterRoleList {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            type Value = ClusterRoleList;

            fn expecting(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
                write!(f, "struct ClusterRoleList")
            }

            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<::v1_7::kubernetes::pkg::apis::rbac::v1alpha1::ClusterRole>> = None;
...
impl ::serde::Serialize for ClusterRoleList {
