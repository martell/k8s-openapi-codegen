// Generated from definition io.k8s.kubernetes.pkg.apis.rbac.v1alpha1.RoleBindingList

/// RoleBindingList is a collection of RoleBindings
#[derive(Clone, Debug, Default, PartialEq)]
pub struct RoleBindingList {
    /// Items is a list of RoleBindings
    pub items: Vec<::v1_7::kubernetes::pkg::apis::rbac::v1alpha1::RoleBinding>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<::v1_7::kubernetes::pkg::apis::rbac::v1alpha1::RoleBinding>> = None;
