// Generated from definition io.k8s.kubernetes.pkg.apis.batch.v1.JobList

/// JobList is a collection of jobs.
#[derive(Clone, Debug, Default, PartialEq)]
pub struct JobList {
    /// items is the list of Jobs.
    pub items: Vec<::v1_7::kubernetes::pkg::apis::batch::v1::Job>,

    /// Standard list metadata. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata
    pub metadata: Option<::v1_7::apimachinery::pkg::apis::meta::v1::ListMeta>,
}

impl ::Resource for JobList {
...
impl<'de> ::serde::Deserialize<'de> for JobList {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn expecting(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
                write!(f, "struct JobList")
            }

            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<::v1_7::kubernetes::pkg::apis::batch::v1::Job>> = None;
...
impl ::serde::Serialize for JobList {
