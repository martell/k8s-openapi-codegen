...
impl ControllerRevision {
    ...
    pub fn create_apps_v1_namespaced_controller_revision(
        namespace: &str,
        body: &::v1_11::api::apps::v1::ControllerRevision,
        pretty: Option<&str>,
...
pub enum CreateAppsV1NamespacedControllerRevisionResponse {
    ...
    Created(::v1_11::api::apps::v1::ControllerRevision),
    Accepted(::v1_11::api::apps::v1::ControllerRevision),
    Unauthorized,
    Other,
}
...
pub enum DeleteAppsV1CollectionNamespacedControllerRevisionResponse {
    ...
    OkValue(::v1_11::api::apps::v1::ControllerRevision),
    Unauthorized,
    Other,
}
