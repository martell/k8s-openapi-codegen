...
pub struct ReplicaSet {
    ...
    pub spec: Option<::v1_11::api::apps::v1::ReplicaSetSpec>,

    /// Status is the most recently observed status of the ReplicaSet. This data may be out of date by some window of time. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
    pub status: Option<::v1_11::api::apps::v1::ReplicaSetStatus>,
}
...
impl ReplicaSet {
    ...
    pub fn create_apps_v1_namespaced_replica_set(
        namespace: &str,
        body: &::v1_11::api::apps::v1::ReplicaSet,
        pretty: Option<&str>,
...
pub enum CreateAppsV1NamespacedReplicaSetResponse {
    Ok(::v1_11::api::apps::v1::ReplicaSet),
    Created(::v1_11::api::apps::v1::ReplicaSet),
    Accepted(::v1_11::api::apps::v1::ReplicaSet),
    Unauthorized,
    Other,
}
...
pub enum DeleteAppsV1CollectionNamespacedReplicaSetResponse {
    ...
    OkValue(::v1_11::api::apps::v1::ReplicaSet),
    Unauthorized,
    Other,
}
...
pub enum ListAppsV1NamespacedReplicaSetResponse {
    Ok(::v1_11::api::apps::v1::ReplicaSetList),
    Unauthorized,
    Other,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<::v1_11::api::apps::v1::ReplicaSetSpec> = None;
                let mut value_status: Option<::v1_11::api::apps::v1::ReplicaSetStatus> = None;
