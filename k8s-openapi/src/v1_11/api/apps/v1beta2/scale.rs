...
pub struct Scale {
    ...
    pub spec: Option<::v1_11::api::apps::v1beta2::ScaleSpec>,

    /// current status of the scale. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status. Read-only.
    pub status: Option<::v1_11::api::apps::v1beta2::ScaleStatus>,
}
...
impl Scale {
    ...
    pub fn replace_apps_v1beta2_namespaced_deployment_scale(
        name: &str,
        namespace: &str,
        body: &::v1_11::api::apps::v1beta2::Scale,
        pretty: Option<&str>,
    ) -> Result<::http::Request<Vec<u8>>, ::RequestError> {
        let __url = format!("/apis/apps/v1beta2/namespaces/{namespace}/deployments/{name}/scale?", name = name, namespace = namespace);
        let mut __query_pairs = ::url::form_urlencoded::Serializer::new(__url);
...
pub enum ReplaceAppsV1beta2NamespacedDeploymentScaleResponse {
    Ok(::v1_11::api::apps::v1beta2::Scale),
    Created(::v1_11::api::apps::v1beta2::Scale),
    Unauthorized,
    Other,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<::v1_11::api::apps::v1beta2::ScaleSpec> = None;
                let mut value_status: Option<::v1_11::api::apps::v1beta2::ScaleStatus> = None;
