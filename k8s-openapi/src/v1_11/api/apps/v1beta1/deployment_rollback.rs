...
pub struct DeploymentRollback {
    ...
    pub rollback_to: ::v1_11::api::apps::v1beta1::RollbackConfig,
...
impl DeploymentRollback {
    ...
    pub fn create_apps_v1beta1_namespaced_deployment_rollback(
        name: &str,
        namespace: &str,
        body: &::v1_11::api::apps::v1beta1::DeploymentRollback,
        pretty: Option<&str>,
...
pub enum CreateAppsV1beta1NamespacedDeploymentRollbackResponse {
    Ok(::v1_11::apimachinery::pkg::apis::meta::v1::Status),
    Created(::v1_11::apimachinery::pkg::apis::meta::v1::Status),
    Accepted(::v1_11::apimachinery::pkg::apis::meta::v1::Status),
    Unauthorized,
    Other,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                ...
                let mut value_rollback_to: Option<::v1_11::api::apps::v1beta1::RollbackConfig> = None;
