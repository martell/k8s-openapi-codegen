...
pub struct Deployment {
    ...
    pub spec: Option<::v1_11::api::extensions::v1beta1::DeploymentSpec>,

    /// Most recently observed status of the Deployment.
    pub status: Option<::v1_11::api::extensions::v1beta1::DeploymentStatus>,
}
...
impl Deployment {
    ...
    pub fn create_extensions_v1beta1_namespaced_deployment(
        namespace: &str,
        body: &::v1_11::api::extensions::v1beta1::Deployment,
        pretty: Option<&str>,
...
pub enum CreateExtensionsV1beta1NamespacedDeploymentResponse {
    Ok(::v1_11::api::extensions::v1beta1::Deployment),
    Created(::v1_11::api::extensions::v1beta1::Deployment),
    Accepted(::v1_11::api::extensions::v1beta1::Deployment),
    Unauthorized,
    Other,
}
...
pub enum DeleteExtensionsV1beta1CollectionNamespacedDeploymentResponse {
    ...
    OkValue(::v1_11::api::extensions::v1beta1::Deployment),
    Unauthorized,
    Other,
}
...
pub enum ListExtensionsV1beta1DeploymentForAllNamespacesResponse {
    Ok(::v1_11::api::extensions::v1beta1::DeploymentList),
    Unauthorized,
    Other,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<::v1_11::api::extensions::v1beta1::DeploymentSpec> = None;
                let mut value_status: Option<::v1_11::api::extensions::v1beta1::DeploymentStatus> = None;
