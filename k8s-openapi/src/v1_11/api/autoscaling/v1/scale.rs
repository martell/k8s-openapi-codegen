...
pub struct Scale {
    ...
    pub spec: Option<::v1_11::api::autoscaling::v1::ScaleSpec>,

    /// current status of the scale. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status. Read-only.
    pub status: Option<::v1_11::api::autoscaling::v1::ScaleStatus>,
}
...
pub enum PatchAppsV1NamespacedDeploymentScaleResponse {
    Ok(::v1_11::api::autoscaling::v1::Scale),
    Unauthorized,
    Other,
}
...
pub enum ReplaceAppsV1NamespacedDeploymentScaleResponse {
    Ok(::v1_11::api::autoscaling::v1::Scale),
    Created(::v1_11::api::autoscaling::v1::Scale),
    Unauthorized,
    Other,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<::v1_11::api::autoscaling::v1::ScaleSpec> = None;
                let mut value_status: Option<::v1_11::api::autoscaling::v1::ScaleStatus> = None;
