// Generated from definition io.k8s.api.core.v1.ComponentStatusList

/// Status of all the conditions for the component as a list of ComponentStatus objects.
#[derive(Clone, Debug, Default, PartialEq)]
pub struct ComponentStatusList {
    /// List of ComponentStatus objects.
    pub items: Vec<::v1_11::api::core::v1::ComponentStatus>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<::v1_11::api::core::v1::ComponentStatus>> = None;
