...
pub struct ReplicationController {
    ...
    pub spec: Option<::v1_11::api::core::v1::ReplicationControllerSpec>,

    /// Status is the most recently observed status of the replication controller. This data may be out of date by some window of time. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
    pub status: Option<::v1_11::api::core::v1::ReplicationControllerStatus>,
}
...
impl ReplicationController {
    ...
    pub fn create_core_v1_namespaced_replication_controller(
        namespace: &str,
        body: &::v1_11::api::core::v1::ReplicationController,
        pretty: Option<&str>,
...
pub enum CreateCoreV1NamespacedReplicationControllerResponse {
    Ok(::v1_11::api::core::v1::ReplicationController),
    Created(::v1_11::api::core::v1::ReplicationController),
    Accepted(::v1_11::api::core::v1::ReplicationController),
    Unauthorized,
    Other,
}
...
pub enum DeleteCoreV1CollectionNamespacedReplicationControllerResponse {
    ...
    OkValue(::v1_11::api::core::v1::ReplicationController),
    Unauthorized,
    Other,
}
...
pub enum ListCoreV1NamespacedReplicationControllerResponse {
    Ok(::v1_11::api::core::v1::ReplicationControllerList),
    Unauthorized,
    Other,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<::v1_11::api::core::v1::ReplicationControllerSpec> = None;
                let mut value_status: Option<::v1_11::api::core::v1::ReplicationControllerStatus> = None;
