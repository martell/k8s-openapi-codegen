...
pub struct VolumeAttachment {
    ...
    pub spec: ::v1_11::api::storage::v1beta1::VolumeAttachmentSpec,

    /// Status of the VolumeAttachment request. Populated by the entity completing the attach or detach operation, i.e. the external-attacher.
    pub status: Option<::v1_11::api::storage::v1beta1::VolumeAttachmentStatus>,
}
...
impl VolumeAttachment {
    ...
    pub fn create_storage_v1beta1_volume_attachment(
        body: &::v1_11::api::storage::v1beta1::VolumeAttachment,
        pretty: Option<&str>,
...
pub enum CreateStorageV1beta1VolumeAttachmentResponse {
    Ok(::v1_11::api::storage::v1beta1::VolumeAttachment),
    Created(::v1_11::api::storage::v1beta1::VolumeAttachment),
    Accepted(::v1_11::api::storage::v1beta1::VolumeAttachment),
    Unauthorized,
    Other,
}
...
pub enum DeleteStorageV1beta1CollectionVolumeAttachmentResponse {
    ...
    OkValue(::v1_11::api::storage::v1beta1::VolumeAttachment),
    Unauthorized,
    Other,
}
...
pub enum ListStorageV1beta1VolumeAttachmentResponse {
    Ok(::v1_11::api::storage::v1beta1::VolumeAttachmentList),
    Unauthorized,
    Other,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<::v1_11::api::storage::v1beta1::VolumeAttachmentSpec> = None;
                let mut value_status: Option<::v1_11::api::storage::v1beta1::VolumeAttachmentStatus> = None;
