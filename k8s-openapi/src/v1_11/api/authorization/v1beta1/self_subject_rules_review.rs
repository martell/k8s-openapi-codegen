...
pub struct SelfSubjectRulesReview {
    ...
    pub spec: ::v1_11::api::authorization::v1beta1::SelfSubjectRulesReviewSpec,

    /// Status is filled in by the server and indicates the set of actions a user can perform.
    pub status: Option<::v1_11::api::authorization::v1beta1::SubjectRulesReviewStatus>,
}
...
impl SelfSubjectRulesReview {
    ...
    pub fn create_authorization_v1beta1_self_subject_rules_review(
        body: &::v1_11::api::authorization::v1beta1::SelfSubjectRulesReview,
        pretty: Option<&str>,
...
pub enum CreateAuthorizationV1beta1SelfSubjectRulesReviewResponse {
    Ok(::v1_11::api::authorization::v1beta1::SelfSubjectRulesReview),
    Created(::v1_11::api::authorization::v1beta1::SelfSubjectRulesReview),
    Accepted(::v1_11::api::authorization::v1beta1::SelfSubjectRulesReview),
    Unauthorized,
    Other,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<::v1_11::api::authorization::v1beta1::SelfSubjectRulesReviewSpec> = None;
                let mut value_status: Option<::v1_11::api::authorization::v1beta1::SubjectRulesReviewStatus> = None;
