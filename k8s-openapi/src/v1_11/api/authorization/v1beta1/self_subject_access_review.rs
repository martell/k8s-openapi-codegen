...
pub struct SelfSubjectAccessReview {
    ...
    pub spec: ::v1_11::api::authorization::v1beta1::SelfSubjectAccessReviewSpec,
...
impl SelfSubjectAccessReview {
    ...
    pub fn create_authorization_v1beta1_self_subject_access_review(
        body: &::v1_11::api::authorization::v1beta1::SelfSubjectAccessReview,
        pretty: Option<&str>,
...
pub enum CreateAuthorizationV1beta1SelfSubjectAccessReviewResponse {
    Ok(::v1_11::api::authorization::v1beta1::SelfSubjectAccessReview),
    Created(::v1_11::api::authorization::v1beta1::SelfSubjectAccessReview),
    Accepted(::v1_11::api::authorization::v1beta1::SelfSubjectAccessReview),
    Unauthorized,
    Other,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<::v1_11::api::authorization::v1beta1::SelfSubjectAccessReviewSpec> = None;
